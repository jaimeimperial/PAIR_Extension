...
TOGETHER_MODEL_NAMES: dict[Model, str] = {
    ...
    Model.kimi: "together_ai/moonshotai/Kimi-K2.5",
    Model.qwen: "together_ai/Qwen/Qwen3.5-9B",
}
...
LITELLM_TEMPLATES: dict[Model, dict] = {
    ...
    Model.qwen: {
        "initial_prompt_value": "",   # match the repo’s existing open-source style
        "roles": {
    ...
    Model.kimi: {
        "roles": {
            "system": "<|media_begin|>system\n",
            "user": "<|media_begin|>user\n",
            "assistant": "<|media_begin|>assistant\n"
        },
        "post_message": "",
        "initial_prompt_value": "",
        "eos_tokens": ["<|media_end|>"]
    },
}